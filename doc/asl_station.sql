...
VALUES
  (
    'com.asing1elife.teamnote.model.dictionary.TaskLevel',
    'TALE_Normal',
    '普通',
    '0'
  ),
...
VALUES
  (
    'com.asing1elife.teamnote.model.dictionary.TaskStatus',
    'TAST_Init',
    '初始化',
    '0'
  ),
...
VALUES
  (
    'com.asing1elife.teamnote.model.dictionary.ReportType',
    'RETY_Month',
    '月报',
    '0'
  ),
...
VALUES
  (
    'com.asing1elife.teamnote.model.dictionary.SimpleStatus',
    'SIST_Init',
    '初始化',
    '0'
  ),
...
-- 组织表新增是否显示字段
ALTER TABLE al_organization
  CHANGE COLUMN isStar star BOOL DEFAULT FALSE COMMENT '是否收藏',
  ADD COLUMN display BOOL DEFAULT TRUE COMMENT '是否显示' AFTER star;

-- 项目表新增是否显示字段
ALTER TABLE al_project
  ADD COLUMN display BOOL DEFAULT TRUE COMMENT '是否显示' AFTER taskNum;
